/**
 * Custom Input Component with Semantic Color Support
 * 
 * Provides clean semantic form input with validation states.
 * Designed for consistency with MMFL design system and accessibility standards.
 * 
 * Features:
...
export const Input = forwardRef<HTMLInputElement, InputProps>(
  ({ variant = 'outline', size = 'md', isInvalid = false, isDisabled = false, isReadOnly = false, className = '', ...props }, ref) => {
