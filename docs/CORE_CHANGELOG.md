...
- Team page roster actions now rely on the unified `rosterLocked` flag (instead of the removed `isRosterLocked_computed`), preventing undefined reference errors and ensuring locked rosters display the correct state on submit/edit buttons.
